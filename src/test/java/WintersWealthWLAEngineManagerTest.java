...
public class WintersWealthWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(WintersWealthWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/WintersWealthWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/WintersWealthWLAIW/InitOutcome.xml").getDocumentElement();
